...
// String constants for type names (good practice)
const Bug = "bug";
const Dark = "dark";
const Dragon = "dragon";
...
export const pokemonTypes = {
  ...
  [Fire]: {
    ...
    resistance: [Bug, Steel, Fire, Grass, Ice, Fairy], // Added Fairy from its weakness list
  ...
  [Ground]: {
    ...
    resistance: [Poison, Rock], // Electric has no effect, which is an immunity, often grouped with resistance
  ...
  [Normal]: {
    ...
    resistance: [Ghost], // Ghost has no effect, an immunity
    vulnerable: [Fighting],
  },
  [Poison]: {
    image: poison,
    ...
    resistance: [Fighting, Poison, Bug, Grass, Fairy], // Bug was missing
  ...
  [Steel]: {
    ...
    resistance: [
      Normal, Flying, Rock, Bug, Steel, Grass, Psychic, Ice, Dragon, Fairy, Poison // Poison is an immunity
    ],
